...
#     def __init__(self):
#         try:
#             self.conn = MySQLdb.connect('127.0.0.1', 'root', '', 'test', charset='utf8')
...
#     def process_item(self, item, spider):
#         print dict(item)
#         sql = 'insert ignore into cnblog(title,content,url,image_path,article_desc,author,date_pub,article_view,article_common) ' \
